...
module.exports = {
  ...
  execute(message, args, client) {
    ...
    message.reply(new MessageEmbed().setColor("BLACK").setTitle("**link bot**").setDescription("https://discord.com/oauth2/authorize?client_id=855819588263215144&permissions=8&scope=bot")
